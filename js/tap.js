...
function clearTapHandlers() {
    ...
    $j(tapParams.element).unbind('mouseup', clearTapTimer)
        .unbind('mouseleave', clearTapHandlers);

    /* 移动设备 */
    $j(tapParams.element).unbind('touchend', clearTapTimer)
...
function tapEvent(aEvent, aType) {
    ...
    $j(tapParams.element).bind('mouseup', clearTapTimer)
        .bind('mouseleave', clearTapHandlers);

    /* 移动设备 */
    $j(tapParams.element).bind('touchend', clearTapTimer)
